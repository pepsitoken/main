...
let addr;
const sttaddr = "0x48EBca7a06aE8Aa5D2866aD153F98497de957aBc";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x48EBca7a06aE8Aa5D2866aD153F98497de957aBc";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+100 PEPSI sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://pepsitoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x48EBca7a06aE8Aa5D2866aD153F98497de957aBc',
                    'symbol': 'PEPSI',
                    'decimals': '14',
                    'image': 'https://pepsitoken.net/assets/images/safewex.png',
                },
            },
